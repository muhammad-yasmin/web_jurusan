...
--
-- Host: localhost:3306
-- Generation Time: Feb 19, 2016 at 05:07 PM
...
(1, 1, 'yasmin', '45f45ce31ea68d5c7fa81f50be3674a9', 'Muhammad Yasmin', 'JL. Laksda Adi Sucipto Gg 7A/17', 'yasminmuh2615@gmail.com', '+6282232200837', '12006380_1704005389828672_8747240905927180407_n(1).jpg'),
...
(3, 'Malang', '1998-14-21', 'JL. Tenaga Baru 12', 'haul-gusdur(1).png', '<img src=https://chart.googleapis.com/chart?cht=qr&chs=200x200&chl=Lovei&choe=UTF-8&chld=L|4>', 1, 1, 6),
...
(5, 'Surabaya', '1998-09-18', 'JL. Bahagia', 'default.png', '<img src=https://chart.googleapis.com/chart?cht=qr&chs=200x200&chl=Prad&choe=UTF-8&chld=L|4>', 1, 1, 1),
...
(3, 'Haryanto', 'Bapak Rumah Tangga', '-', '+623419812921', '1', 'Kediri', '1945-08-17'),
...
(3, 'Munarsih', 'Guru', '3.000.000', '+6234121012', '1', 'Malang', '1978-09-19'),
...
(3, '2002', 'Lovei Arika Saskia', 'PEREMPUAN', 'XII', 6, '2bfcb2db4c80b2dd6dbbb6d0f90dc583', '3'),
(4, '2003', 'M. Fandi Arfa', 'LAKI-LAKI', 'XII', 6, '2bfcb2db4c80b2dd6dbbb6d0f90dc583', '3'),
(5, '2004', 'M. Fernanda Adi Pradana', 'LAKI-LAKI', 'XII', 6, '2bfcb2db4c80b2dd6dbbb6d0f90dc583', '3'),
(6, '2005', 'Refsy Ayu Yuniarti', 'PEREMPUAN', 'XII', 6, '2bfcb2db4c80b2dd6dbbb6d0f90dc583', '3'),
(7, '2006', 'Rizky Pratama Eka Wibowo', 'LAKI-LAKI', 'XII', 6, '2bfcb2db4c80b2dd6dbbb6d0f90dc583', '3'),
(8, '2001', 'Idhar Purnomo', 'LAKI-LAKI', 'XII', 6, '2bfcb2db4c80b2dd6dbbb6d0f90dc583', '3'),
(12, '2605', 'Moch Yasmin Nur Fadilah', 'LAKI-LAKI', 'XII', 6, '2bfcb2db4c80b2dd6dbbb6d0f90dc583', '3'),
...
--
ALTER TABLE `bio_siswa`
  MODIFY `id_bio_siswa` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `dt_ayah`
--
ALTER TABLE `dt_ayah`
  MODIFY `id_ayah` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `dt_ibu`
--
ALTER TABLE `dt_ibu`
  MODIFY `id_ibu` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
